'use strict';
import { fetchHtml, type SubtitleOptions, type SubtitleInfo, MovieList, SubtitleList } from '../utils/download';

const DOMAIN = 'subdl.com';
const SITE = 'https://' + DOMAIN;

class SubdlMovieLink extends MovieList {
...
class SubdlSubtitleLink extends SubtitleList {
