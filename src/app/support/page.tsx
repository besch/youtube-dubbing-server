...
export default function SupportPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-900 to-black text-neutral-300 font-[family-name:var(--font-geist-sans)]">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-neutral-400">
                ...
                based on audio quality, speaker accents, and language
                complexity. We strive for the best possible results, but
                occasional inaccuracies may occur.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-lg text-violet-400 mb-2">
            ...
            <div>
              ...
              <p className="text-neutral-400">
                Yes, you can select different supported languages or voices for
                a video you've already processed. If the selected combination
        ...
        {helpCenterLink !== "#" && (
          <section>
            <div className="text-center">
              ...
              >
                <HelpCircle size={20} /> Need immediate assistance? Visit our
                Help Center
              </Link>
            </div>
          </section>
