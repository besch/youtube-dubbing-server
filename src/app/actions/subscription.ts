...
// NOTE: Stripe webhook processing lives in the canonical handler at
// `src/app/api/webhooks/stripe/route.ts`. This file previously contained a
// divergent duplicate (`handleStripeWebhook`) which has been removed to avoid
// drift. All webhook event handling should go through that single route.
