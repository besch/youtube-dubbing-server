...
CREATE INDEX "idx_videos_translated_titles" ON "public"."videos" USING "gin" ("translated_titles");



CREATE OR REPLACE TRIGGER "Trigger Downloader on New Job" AFTER INSERT ON "public"."download_jobs" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://youtube-downloader-550129149777.europe-west1.run.app/webhook', 'POST', '{"Content-type":"application/json"}', '{}', '8000');
